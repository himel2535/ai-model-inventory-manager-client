...
const AboutSection = () => {
  return (
    <section className="mt-8 mb-6 md:mt-10 md:mb-6 lg:mt-12 lg:mb-2 p-8 md:p-10 lg:p-10">
      <h2 className="lg:text-4xl md:text-3xl text-2xl text-center font-bold mb-6">About AI Models</h2>
